...
public class DeliveryScopeCopilotRunRequestAssembler {

    private static final String DENIED_TOOL_MESSAGE =
            "This is a one-shot Delivery Scope Complexity. Use only the inline prompt and return JSON.";
    ...
    public CopilotRunRequest assemble(
        ...
        var sessionConfig = new CopilotSessionConfigRequest(
                "delivery-scope-complexity-" + UUID.randomUUID(),
                List.of(),
                List.of(),
