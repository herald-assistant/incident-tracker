...
import pl.mkn.tdw.features.deliveryscopecomplexity.ai.DeliveryAiResponseParser;
...
public class DeliveryScopeCopilotProvider implements DeliveryUnitAssessmentProvider {

    private final DeliveryScopeCopilotRunRequestAssembler runRequestAssembler;
