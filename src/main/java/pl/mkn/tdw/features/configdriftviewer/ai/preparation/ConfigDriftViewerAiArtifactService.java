...
public class ConfigDriftViewerAiArtifactService {
    ...
    public ConfigDriftViewerAiArtifacts render(
        ...
        artifacts.put("config-drift-viewer/response-contract.json", responseContract());
        return new ConfigDriftViewerAiArtifacts(artifacts, visibilityLimits);
    }

    private Map<String, Object> scope(ConfigDriftViewerDeterministicContext context) {
    ...
    private Map<String, Object> changes(ConfigDriftViewerDeterministicContext context) {
        var result = new LinkedHashMap<String, Object>();
        result.put("formatVersion", 1);
    ...
    private List<Object> compactDifference(ConfigDriftViewerDifference difference) {
    ...
    private String relationCode(
            pl.mkn.tdw.features.configdriftviewer.deterministic.model
                    .ConfigDriftViewerChangeKind value
    ) {
        if (value == null) {
            return null;
        }
    ...
    private String typeCode(ConfigDriftViewerValueType value) {
        if (value == null) {
            return null;
        }
        return switch (value) {
    ...
    private String sensitivityCode(ConfigDriftViewerSensitivity value) {
        if (value == null) {
            return null;
        }
        return value == ConfigDriftViewerSensitivity.SENSITIVE ? "S" : "N";
    }
    ...
    public record ConfigDriftViewerAiArtifacts(
            Map<String, String> contents,
            List<String> visibilityLimits
    ) {

        public ConfigDriftViewerAiArtifacts {
