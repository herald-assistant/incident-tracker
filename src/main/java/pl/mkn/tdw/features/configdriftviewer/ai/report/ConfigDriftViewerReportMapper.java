...
@Component
public class ConfigDriftViewerReportMapper {
    ...
    public AnalysisReport merge(
        ...
        var allowed = ConfigDriftViewerReportSectionIds.aiWritable();
    ...
    private String fallbackMarkdown(String sectionId, ConfigDriftViewerAiSecondOpinion opinion) {
        if (opinion == null) {
            return "AI second opinion is unavailable.";
        }
        if (ConfigDriftViewerReportSectionIds.AI_SECOND_OPINION.equals(sectionId)) {
        ...
        if (ConfigDriftViewerReportSectionIds.RECOMMENDED_HUMAN_CHECKS.equals(sectionId)) {
        ...
        if (ConfigDriftViewerReportSectionIds.FUNCTIONAL_IMPACT_AND_CODE_GROUNDING.equals(sectionId)) {
