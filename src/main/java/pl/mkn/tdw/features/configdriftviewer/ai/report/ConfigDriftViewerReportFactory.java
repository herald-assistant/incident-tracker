...
@Component
public class ConfigDriftViewerReportFactory {
    ...
    public AnalysisReport createInitialReport(
        ...
        sections.add(section(
                ConfigDriftViewerReportSectionIds.VERIFICATION_SUMMARY,
        ...
        sections.add(section(
                ConfigDriftViewerReportSectionIds.DETERMINISTIC_DIFFERENCES,
        ...
        sections.add(section(
                ConfigDriftViewerReportSectionIds.DETERMINISTIC_FINDINGS,
        ...
        sections.add(section(
                ConfigDriftViewerReportSectionIds.AI_SECOND_OPINION,
                "AI second opinion",
                sections.size(),
        ...
        sections.add(section(
                ConfigDriftViewerReportSectionIds.RECOMMENDED_HUMAN_CHECKS,
        ...
        sections.add(section(
                ConfigDriftViewerReportSectionIds.AFFECTED_SYSTEMS_AND_CONTEXT,
        ...
        sections.add(section(
                ConfigDriftViewerReportSectionIds.FUNCTIONAL_IMPACT_AND_CODE_GROUNDING,
        ...
        sections.add(section(
                ConfigDriftViewerReportSectionIds.OWNERSHIP_AND_HANDOFF,
        ...
        sections.add(section(
                ConfigDriftViewerReportSectionIds.VISIBILITY_AND_GAPS,
                "Visibility and gaps",
                sections.size(),
                visibility(deep),
    ...
    private String summary(ConfigDriftViewerDeterministicContext context) {
        return """
    ...
    private String differences(ConfigDriftViewerDeterministicContext context) {
    ...
    private String findings(ConfigDriftViewerDeterministicContext context) {
    ...
    private String affectedContext(ConfigDriftViewerDeepContext deep) {
        if (deep == null) {
    ...
    private void appendEntities(
            List<String> lines,
            String label,
            List<ConfigDriftViewerAffectedEntity> entities
    ) {
        entities.forEach(entity -> lines.add("- " + label + ": `" + entity.contextId()
                + "` — " + entity.label() + " (" + entity.confidence() + ")"));
    }

    private String codeGrounding(ConfigDriftViewerDeepContext deep) {
    ...
    private String ownership(ConfigDriftViewerDeepContext deep) {
    ...
    private String visibility(ConfigDriftViewerDeepContext deep) {
        var lines = new ArrayList<String>();
        if (deep != null) {
    ...
    private AnalysisReportMeta deterministicMeta(ConfigDriftViewerDeterministicContext context) {
    ...
    private AnalysisReportMeta differenceMeta(ConfigDriftViewerDeterministicContext context) {
    ...
    private AnalysisReportMeta findingMeta(ConfigDriftViewerDeterministicContext context) {
        return new AnalysisReportMeta(
    ...
    private AnalysisReportMeta deepMeta(ConfigDriftViewerDeepContext deep) {
        if (deep == null) {
    ...
    private AnalysisReportMeta codeMeta(ConfigDriftViewerDeepContext deep) {
        if (deep == null) {
            return AnalysisReportMeta.empty();
        }
        return new AnalysisReportMeta(
    ...
    private List<ConfigDriftViewerAffectedEntity> allAffected(ConfigDriftViewerDeepContext deep) {
