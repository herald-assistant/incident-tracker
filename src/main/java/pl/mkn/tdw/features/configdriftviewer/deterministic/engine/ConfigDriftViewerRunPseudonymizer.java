...
final class ConfigDriftViewerRunPseudonymizer {
    ...
    ConfigDriftViewerRunPseudonymizer() {
    ...
    ConfigDriftViewerRunPseudonymizer(byte[] key, String runPrefix) {
        this.key = key.clone();
    ...
    public String toString() {
        return "ConfigDriftViewerRunPseudonymizer[key=<redacted>, runPrefix=<redacted>, valueTokens="
