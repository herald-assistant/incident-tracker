...
@Component
public class BoundedRuntimeConfigurationComponentExecutor
        implements RuntimeConfigurationComponentExecutor {

    private final ThreadPoolTaskExecutor executor;

    public BoundedRuntimeConfigurationComponentExecutor(
            RuntimeConfigurationRepositoryProperties properties
    ) {
