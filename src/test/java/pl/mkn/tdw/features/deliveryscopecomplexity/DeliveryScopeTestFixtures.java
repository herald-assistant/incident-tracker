package pl.mkn.tdw.features.deliveryscopecomplexity;
...
public final class DeliveryScopeTestFixtures {

    private DeliveryScopeTestFixtures() {
    }
    ...
    public static DeliveryScopeIssue issue(String key) {
        return new DeliveryScopeIssue(
                key,
    ...
    public static DeliveryScopeIssueSource source(String key, GitLabMergeRequest... mergeRequests) {
        return new DeliveryScopeIssueSource(issue(key), List.of(mergeRequests), List.of());
    }
