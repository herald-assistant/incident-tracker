...
class DeliveryComplexityAssessmentJobServiceTest {
    ...
    private DeliveryComplexityAssessmentJobService service;
    ...
    void setUp() {
        ...
        when(promptPreparationService.prepare(any())).thenReturn(new DeliveryPromptPreparation(
                ...
                Map.of("delivery-complexity/issues.md", "issue")
        ));
        service = new DeliveryComplexityAssessmentJobService(
                source,
    ...
    private DeliveryComplexityAssessmentJobStartRequest request() {
        return new DeliveryComplexityAssessmentJobStartRequest(
