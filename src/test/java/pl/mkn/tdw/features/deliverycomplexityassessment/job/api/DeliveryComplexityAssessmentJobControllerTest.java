...
class DeliveryComplexityAssessmentJobControllerTest {

    private final DeliveryComplexityAssessmentJobService service = mock(DeliveryComplexityAssessmentJobService.class);
    private MockMvc mockMvc;

    @BeforeEach
    void setUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(new DeliveryComplexityAssessmentJobController(service)).build();
    }
    ...
    void shouldStartAndReadFeatureJob() throws Exception {
        ...
        mockMvc.perform(post("/api/delivery-complexity-assessment/jobs")
        ...
        mockMvc.perform(get("/api/delivery-complexity-assessment/jobs/job-1"))
