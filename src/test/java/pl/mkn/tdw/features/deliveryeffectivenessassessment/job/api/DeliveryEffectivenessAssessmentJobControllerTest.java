...
import pl.mkn.tdw.features.deliveryeffectivenessassessment.job.DeliveryEffectivenessAssessmentJobService;
...
class DeliveryEffectivenessAssessmentJobControllerTest {

    private final DeliveryEffectivenessAssessmentJobService service = mock(DeliveryEffectivenessAssessmentJobService.class);
    private MockMvc mockMvc;

    @BeforeEach
    void setUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(new DeliveryEffectivenessAssessmentJobController(service)).build();
    }
    ...
    void shouldStartAndReadFeatureJob() throws Exception {
        ...
        mockMvc.perform(post("/api/delivery-effectiveness-assessment/jobs")
        ...
        mockMvc.perform(get("/api/delivery-effectiveness-assessment/jobs/job-1"))
