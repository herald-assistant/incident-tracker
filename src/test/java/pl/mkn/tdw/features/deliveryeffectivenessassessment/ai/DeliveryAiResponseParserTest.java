    ...
    void shouldParseDeliveryJsonEmbeddedAfterReportToolWork() {
        var response = parser.parse("""
                Assessment complete.
                {
                  ...
                  "confidence":0.75,
                  "evidenceSummary":[
                    "outcomeBreadth | delivery-effectiveness/issues.md#DEA-1 | API behavior changed",
                    "domainDecisionComplexity | delivery-effectiveness/issues.md#DEA-1 | validation rule added",
                    "applicationFlowComplexity | delivery-effectiveness/diffs.md#service!1 | error flow added",
                    "boundaryAndDataComplexity | delivery-effectiveness/diffs.md#service!1 | request mapping changed",
                    "verificationStateSpace | delivery-effectiveness/issues.md#DEA-1 | success and error variants",
                    "implementedCompatibilityScope | delivery-effectiveness/diffs.md#service!1 | fallback retained"
                  ],
                  "qualityFlags":[],
                  "visibilityLimits":[]
                }
