...
class ConfigDriftViewerJobStateConcurrencyTest {

    @Test
    void shouldCreateConsistentSnapshotsDuringConcurrentAiUpdates() throws Exception {
        var state = new ConfigDriftViewerJobState(
                "job-1",
                ConfigDriftViewerJobServiceTest.deepRequest()
        );
        ...
        state.markDiffCompleted(ConfigDriftViewerJobServiceTest.deterministicBuild());
