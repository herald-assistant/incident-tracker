...
const TYPE_FIELDS: Record<OperationalContextWritableType, OperationalContextFormSection[]> = {
  system: [
    ...
    { title: 'Signals and advanced', fields: [
      field('matchSignals', 'Match signals', 'match-signals', 'Add durable evidence values and assign each one a confidence bucket and signal key, such as serviceNames, routes or aliases.', 'The resolver and AI tools compare evidence with these values to identify the system; stronger buckets communicate higher match confidence.', 'Guided rows. Confidence is exact, strong, medium or weak. Choose a recommended signal key for this entity; enter one distinct value per line.', { example: 'Add exact / serviceNames / crm-contact-service and strong / routes / /crm/contacts.' }),
  ...
  repository: [
    ...
    { title: 'Signals and advanced', fields: [
      field('matchSignals', 'Match signals', 'match-signals', 'Add repository evidence values such as projectNames, projectPaths, build coordinates or aliases and assign their confidence.', 'Project names and paths join the repository resolver signal set and help runtime evidence and AI locate the correct code source.', 'Guided rows. Confidence is exact, strong, medium or weak; signal keys come from repository conventions and existing data.', { example: 'Add exact / projectPaths / crm/contact-service and strong / projectNames / contact-service.' }),
  ...
  process: [
    ...
    { title: 'Signals and advanced', fields: [
      ...
      field('matchSignals', 'Match signals', 'match-signals', 'Add durable business or runtime evidence values that identify this process and assign their confidence.', 'Used by operational-context search and exposed to AI to resolve logs, routes or business phrases to the process.', 'Guided rows using exact, strong, medium or weak and process-oriented keys such as businessTerms, routes, operationNames or exchanges.', { example: 'Add strong / businessTerms / update CRM contact and medium / routes / /crm/contacts.' })
    ] }
  ],
  integration: [
    { title: 'Basic', fields: [...BASE_FIELDS,
    ...
    { title: 'Signals and advanced', fields: [
      field('matchSignals', 'Match signals', 'match-signals', 'Add durable endpoints, queues, routes, bindings or business phrases that identify this integration.', 'Used by search/resolution and exposed to AI so technical evidence maps to the correct boundary.', 'Guided rows using exact, strong, medium or weak and integration-oriented signal keys.', { example: 'Add exact / routes / /crm/contacts/sync and strong / operationNames / sync CRM contact.' }),
  ...
  'bounded-context': [
    ...
    { title: 'Signals and advanced', fields: [
      field('matchSignals', 'Match signals', 'match-signals', 'Add durable domain phrases, routes, configuration keys or other evidence that indicates this bounded context.', 'Used by search and ownership inference to map evidence to the context; AI sees confidence-grouped signals.', 'Guided rows using exact, strong, medium or weak and bounded-context-oriented signal keys.', { example: 'Add strong / businessTerms / CRM contact preference and medium / routes / /crm/contacts.' }),
  ...
  team: [
    ...
    { title: 'Signals', fields: [
      field('matchSignals', 'Match signals', 'match-signals', 'Add stable team names, aliases, email aliases or collaboration identifiers and assign their confidence.', 'Improves team search and helps AI recognize the same team label in evidence; it does not make the team an owner by itself.', 'Guided rows using exact, strong, medium or weak and team-oriented signal keys.', { example: 'Add exact / teamNames / CRM Domain Team and strong / aliases / crm-domain-team.' })
    ] }
  ],
  'glossary-term': [
    { title: 'Basic', fields: [
    ...
    { title: 'References and advanced', fields: [
      field('matchSignals', 'Match signals', 'match-signals', 'Add phrases, aliases, field names or other durable evidence that identifies this glossary meaning.', 'Used by glossary search and AI term resolution to match operational evidence to this definition.', 'Guided rows using exact, strong, medium or weak and glossary-oriented signal keys, including existing specialized keys.', { example: 'Add exact / phrases / customer profile and strong / aliases / CRM profile.' }),
